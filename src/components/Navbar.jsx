...
const Navbar = () => {
  ...
  return (
    <nav className="w-full px-6 py-4 bg-white dark:bg-gray-900 shadow-md sticky z-50 top-0 flex font-bold font-poppins items-center justify-between transition-colors duration-300">
      {/* Logo */}
      <NavLink to="/" className="flex items-center space-x-2">
        <FiShoppingBag className="text-green-500 text-3xl" />
        <h1 className="text-3xl font-bold text-primary dark:text-green-300 font-logo">
          HAMRO MART
        </h1>
      </NavLink>
      ...
      {/* Desktop Menu Items */}
      <div className="hidden md:flex items-center space-x-6 text-primary dark:text-green-400">
      ...
      <button
        ...
        className="md:hidden text-primary dark:text-green-400 focus:outline-none"
      ...
      >
        <div className="flex flex-col p-6 space-y-6 text-primary dark:text-green-400">
          {isLoggedIn ? (
            <button
              onClick={handleLogout}
              className="flex items-center space-x-2 hover:text-green-500 focus:outline-none"
            >
