    ...
    if (loading) {
        return (
            <div className="flex justify-center items-center h-screen">
                <div className="text-2xl font-semibold text-gray-600 animate-pulse">Loading Dashboard...</div>
            </div>
        );
    }
...
function StatCard({ title, value, icon, gradient }) {
    return (
        <div className={`bg-gradient-to-br ${gradient} backdrop-blur-md rounded-2xl p-6 shadow-xl transform hover:scale-105 transition-all duration-300`}>
